  ...
  schemas: {
    ...
    User: {
      ...
      properties: {
        ...
        role: { type: "string", enum: ["user", "admin", "alumnus"], example: "user" },
    ...
    Executive: {
      type: "object",
      properties: {
        id: { type: "string", example: "65f9c1d43f2e2c0012abc777" },
        name: { type: "string", example: "Tolu Adeyemi" },
        email: { type: "string", format: "email", example: "tolu@email.com" },
        profilePicture: { type: "string", nullable: true },
        role: { type: "string", example: "President" },
        position: { type: "string", example: "Executive President" },
        title: { type: "string", example: "IFASA Alumni Association" },
    ...
    Setting: { type: "object", properties: { siteName: { type: "string" }, siteDescription: { type: "string" }, contactEmail: { type: "string" }, contactPhone: { type: "string" }, contactAddress: { type: "string" }, socialLinks: { type: "object" }, donationLink: { type: "string" }, donationAccountNumber: { type: "string" }, donationBankName: { type: "string" }, footerText: { type: "string" }, allowRegistrations: { type: "boolean" }, enableDonations: { type: "boolean" } } },
  },
};
