    ...
    get: {
      ...
      responses: {
        200: successResponse({
          ...
          example: { totalAmount: 1200000, totalCount: 18, completedAmount: 1000000, completedCount: 15 },
        }),
      },
    },
  },
      ...
      responses: {
        200: successResponse({
          ...
          dataSchema: {
            type: "object",
            properties: {
              featuredAlumni: { type: "array", items: { $ref: "#/components/schemas/User" } },
              latestNews: { type: "array", items: { $ref: "#/components/schemas/News" } },
              upcomingEvents: { type: "array", items: { $ref: "#/components/schemas/Event" } },
              featuredOpportunities: { type: "array", items: { $ref: "#/components/schemas/Opportunity" } },
              donationSummary: { type: "object" },
            },
          },
          example: {
            featuredAlumni: [{ id: "1", fullName: "Tunde Adebayo" }],
            latestNews: [{ id: "1", title: "IFASA Alumni Spotlight Series Launches" }],
            upcomingEvents: [{ id: "1", title: "IFASA Global Reunion 2026" }],
            featuredOpportunities: [{ id: "1", title: "Graduate Architect" }],
            donationSummary: { totalAmount: 1200000, completedAmount: 1000000 },
          },
        }),
      },
    },
    ...
    get: {
      ...
      responses: {
        200: successResponse({
          ...
          example: {
            totals: { alumni: 120, pendingApprovals: 5, events: 8, news: 14, opportunities: 11, donations: 18 },
            recentActivity: [{ action: "auth.google-login", description: "User authenticated with Google." }],
          },
        }),
      },
    },
