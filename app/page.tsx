    ...
    <div className="grid bg-[#f5f5f5]">
      <section className="relative grid h-max">
        <Image
          ...
          height={1000}
        />
        <div className="absolute  bg-[#0e00009d] w-full h-full py-[4em]"></div>
        <div className="absolute grid place-items-center w-full h-full">
          <div className="w-[90%] md:w-[80%]">
            <h1 className="text-[2.2em] md:text-[3em] lg:text-[3.5em] xl:text-[4em] font-semibold text-white leading-[1.2em] text-shadow-lg/20 font-montserrat">
